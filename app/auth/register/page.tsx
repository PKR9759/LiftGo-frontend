    ...
    <div className="min-h-screen flex items-center justify-center px-4 py-12">
      <div className="w-full max-w-sm">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-slate-500 text-sm mt-1">Join LiftGo and start sharing rides</p>
        </div>
        ...
        <div className="bg-white border rounded-xl p-6 shadow-sm">
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
            ...
            <div>
              <Label htmlFor="confirm" className="text-sm mb-1 block">
                Confirm password
              </Label>
              <Input
                id="confirm"
              ...
              <div className="grid grid-cols-3 gap-2">
                {(['rider', 'driver', 'both'] as const).map(r => (
                  ...
                  >
                    ...
                    />
                    <div className="text-center border rounded-lg py-2 text-sm text-slate-600
                      peer-checked:border-slate-900 peer-checked:bg-slate-900
                      peer-checked:text-white transition-colors capitalize">
